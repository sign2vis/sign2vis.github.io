...
from sign2vis.modules.search import beam_search
...
def inference_slt_beam(slt_model, tokenizer, video_array, video_array_mask, beam_size=5, beam_max_length=100, alpha=0, vocab_size=30522):
