...
def build_vocab_just_nl(data_dir, db_info, batch_size, max_input_length):
...
def build_vocab_only(data_dir, db_info, max_input_length):
    ...
    return SRC, TRG, TOK_TYPES, max_input_length


def build_vocab_just_nl_only(data_dir, db_info, max_input_length):
